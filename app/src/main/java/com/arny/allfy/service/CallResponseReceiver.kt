...
import com.arny.allfy.domain.usecase.message.AcceptCallUseCase
import com.arny.allfy.domain.usecase.message.EndCallUseCase
import com.arny.allfy.domain.usecase.message.RejectCallUseCase
...
class CallResponseReceiver : BroadcastReceiver() {
    ...
    @Inject
    lateinit var rejectCallUseCase: RejectCallUseCase
